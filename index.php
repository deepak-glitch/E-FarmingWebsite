	...
	?>
				...
				<div class="container">
					...
					<div class="row 200%">
						...
						<section class="4u$ 12u$(small)">
							...
							<p><button onclick="window.location.href='https://agmarknet.gov.in/PriceTrends'">Market Price</button></p>
						</section>
					</div>
				</div>
			</section>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Farmers Portal<span>Hyderabad,India</span></p>
			</div>
			<div>
